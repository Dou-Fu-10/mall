package org.example.modules.portal.product.entity;
...
public class PublicProductCategoryEntity extends CommonEntity<PublicProductCategoryEntity> implements Serializable {
    ...
    public PublicProductCategoryEntity(Long id, Boolean navStatus, Boolean showStatus) {
        this.id = id;
